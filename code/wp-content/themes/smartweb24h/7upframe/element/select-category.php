            ...
            switch ($style) {
                ...
                default:
                    $html .=    '<div class="item-lower-price">
                                    ...
                                    <a href="'.esc_url($term_link).'" class="viewall">'.esc_html__("VIEW ALL","supershop").'</a>
                                </div>';
                    break;
            }            
        }
...
if ( ! function_exists( 'sv_admin_select_category' ) ) {
    function sv_admin_select_category(){
        vc_map( array(
            "name"      => esc_html__("SV Select Product Category", 'supershop'),
            ...
            "params"    => array(
                ...
                array(
                    "type" => "textfield",
                    "heading" => esc_html__("Label",'supershop'),
                    "param_name" => "label",
                    "dependency"    => array(
                        "element"   => 'style',
                        "value"   => 'default',
                ...
                array(
                    "type" => "textfield",
                    "holder" => "div",
                    "heading" => esc_html__("Text link",'supershop'),
