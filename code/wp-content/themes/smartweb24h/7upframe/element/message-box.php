...
vc_map( array(
    "name"      => esc_html__("SV Message Box", 'supershop'),
    "base"      => "sv_message_box",
    "icon"      => "icon-st",
    "category"  => '7Up-theme',
    "params"    => array(
        array(
            ...
            "param_name" => "style",
            "value"     => array(
                esc_html__("Info",'supershop')   => 'item-message-info',
                esc_html__("Success",'supershop')   => 'item-message-success',
                esc_html__("Error",'supershop')   => 'item-message-error',
                esc_html__("Warning",'supershop')   => 'item-message-warning',
                )
        ),
        array(
            "type" => "textfield",
        ...
        array(
            "type" => "textarea",
            "holder"    => 'div',
            "heading" => esc_html__("Message",'supershop'),
            "param_name" => "message",
        ),
    )
));