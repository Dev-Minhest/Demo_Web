	...
	function sv_latest_news( $atts, $shortcode_content = null ) {
		...
		$html .=	'<div class="latest-testimo-tab">
						<div class="latest-testimo-title popular-cat-tab-title">
							<ul class="title-tab3">
								<li class="active"><a href="'.esc_url('#latest-'.$pre).'" data-toggle="tab">'.esc_html__("latest news","supershop").'</a></li>
								<li><a href="'.esc_url('#testimo-'.$pre).'" data-toggle="tab">'.esc_html__("testimonials","supershop").'</a></li>
							</ul>
						</div>
...
vc_map(
	array(
		'name'     => esc_html__( 'SV Latest News Tab', 'supershop' ),
		'base'     => 'latest_news',
		...
		'params'   => array(
            ...
            array(
                ...
                "heading" => esc_html__("Testimonials",'supershop'),
