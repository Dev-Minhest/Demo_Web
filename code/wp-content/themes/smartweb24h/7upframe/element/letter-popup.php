                            ...
                            <div class="window" id="dialog">
                                <div class="window-popup"> 
                                    ...
                                    <div class="content-popup">
                                        ...
                                        <p><input type="checkbox" id="check-popup" /><label for="check-popup">'.esc_html__("Do not show this popup again","supershop").'</label></p>
                                    </div>
...
vc_map( array(
    "name"      => esc_html__("SV Letter Popup", 'supershop'),
