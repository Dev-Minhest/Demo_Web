...
vc_map(
    array(
        'name'     => esc_html__( 'Service Wrap', 'supershop' ),
        'base'     => 'service_wrap',
...
vc_map(
    array(
        'name'     => esc_html__( 'Service Item', 'supershop' ),
        'base'     => 'service_item',
        'icon'     => 'icon-st',
        'content_element' => true,
...
vc_map(
    array(
        'name'     => esc_html__( 'SV Service', 'supershop' ),
        'base'     => 'sv_service',
        'icon'     => 'icon-st',
        "category"  => '7Up-theme',
        'params'   => array(
            array(
                ...
                "param_name"    => "style",
                "value"         => array(
                    esc_html__("Style 1",'supershop')        => 'item-service3',
                    esc_html__("Style 2",'supershop')         => 'item-service2',
                    esc_html__("Style 3",'supershop')         => 'home-11',
                    )
            ),
            array(
                'type'        => 'textfield',
            ...
            array(
                ...
                'dependency'  => array(
                    'element'   => 'style',
                    'value'   => array('item-service3','item-service2'),
                    )
            ),
            array(
                'type'        => 'textfield',
