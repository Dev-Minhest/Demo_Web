    ...
    if(!function_exists('sv_vc_product_category'))
    {
        function sv_vc_product_category($attr, $content = false)
        {
            ...
            if(!empty($term) && is_object($term)){
                ...
                switch ($style) {
                    case 'home-19':
                        $html .=    '<div class="featured-product2 '.$color3.' clearfix featured-product-cat">
                                ...
                                $html .=    '<div class="item-featured-product">
                                                <div class="featured-product-info product-info2">
                                                    <div class="featured-info-sale">
                                                        ...
                                                        <label class="new">'.esc_html__("New","supershop").'</label>
                                                    </div>
                        ...
                        if(!empty($tags)){
                            $html .=        '<div class="tags-featured-product">
                                                <label><i class="fa fa-tags"></i> '.esc_html__("tags","supershop").':</label>';
                    ...
                    case 'home-12':
                        $html .=    '<div class="clearfix category-product-featured featured-product12 '.$color.'">                        
                            ...
                            if(in_array('bestsell', $types_fillter))  $html .=    '<div class="item">
                                                            <div class="item-filter">
                                                                <a class="load-product-data-home12" href="#" data-product_type="bestsell">
                                                                    ...
                                                                    <span>'.esc_html__("Best seller","supershop").'</span>
                                                                </a>
                                                            </div>
                                                        </div>';
                            if(in_array('mostview', $types_fillter))  $html .=    '<div class="item">
                                                            <div class="item-filter">
                                                                <a class="load-product-data-home12" href="#" data-product_type="mostview">
                                                                    ...
                                                                    <span>'.esc_html__("Most View","supershop").'</span>
                                                                </a>
                                                            </div>
                                                        </div>';
                            if(in_array('featured', $types_fillter))  $html .=    '<div class="item">
                                                            <div class="item-filter">
                                                                <a class="load-product-data-home12" href="#" data-product_type="featured">
                                                                    ...
                                                                    <span>'.esc_html__("Special","supershop").'</span>
                                                                </a>
                                                            </div>
                                                        </div>';
                            if(in_array('newarrival', $types_fillter))  $html .=    '<div class="item">
                                                            <div class="item-filter">
                                                                <a class="load-product-data-home12" href="#" data-product_type="newest">
                                                                    ...
                                                                    <span>'.esc_html__("New Arrivals","supershop").'</span>
                                                                </a>
                                                            </div>
                                                        </div>';
                            if(in_array('mostreview', $types_fillter))  $html .=    '<div class="item">
                                                            <div class="item-filter">
                                                                <a class="load-product-data-home12" href="#" data-product_type="mostreview">
                                                                    ...
                                                                    <span>'.esc_html__("Most Review","supershop").'</span>
                                                                </a>
                                                            </div>
                                                        </div>';
                            if(in_array('onsale', $types_fillter))  $html .=    '<div class="item">
                                                            <div class="item-filter">
                                                                <a class="load-product-data-home12" href="#"  data-product_type="onsale">
                                                                    ...
                                                                    <span>'.esc_html__("Sale","supershop").'</span>
                                                                </a>
                                                            </div>
                                                        </div>';    
                            $html .=        '</div>
                    ...
                    case 'home-11':
                        $view_cat_link = '';
                        if($view_more == 'yes') $view_cat_link = '<div class="super-deal-content"><a href="'.esc_url($term_link).'" class="view-all-deal" data-hover="'.esc_html__("View More","supershop").'"><span>'.esc_html__("View More","supershop").'</span></a></div>';
                        $html .=    '<div class="content-popular11">
                    ...
                    case 'home-10':
                        $html .=    '<div class="box-category10 '.$color4.' clearfix">
                                        <input type="hidden" class="data-load-ajax" data-cat="'.$term->slug.'" data-number="'.$number.'" data-order="'.$order.'" data-orderby="'.$order_by.'" data-product_type="'.$type_home7.'" />
                    ...
                    case 'home-9-2':
                        $html .=    '<div class="category-adv home-9 '.$color4.' clearfix content-'.$content_pos.'">
                                        <input type="hidden" class="data-load-ajax" data-cat="'.$term->slug.'" data-number="'.$number.'" data-order="'.$order.'" data-orderby="'.$order_by.'" data-product_type="'.$type_home7.'" />';
                        ...
                        $html .=            '<div class="no-product hidden"><h3>'.esc_html__("No Product are display.","supershop").'</h3></div>
                                ...
                                $html .=   '<div class="item-paginav-featured">
                                                <div class="inner-item-paginav-featured">
                                                    ...
                                                    <div class="paginav-featured-info">
                                                        '.$value['des'].'
                                                        <a href="'.esc_url($value['link']).'" class="shopnow">'.esc_html__("shop now","supershop").'</a>
                                                    </div>
                                                </div>
                                            </div>';
                    ...
                    case 'home-9':
                        $html .=    '<div class="category-adv home-9 '.$color4.' clearfix">
                                        <input type="hidden" class="data-load-ajax" data-cat="'.$term->slug.'" data-number="'.$number.'" data-order="'.$order.'" data-orderby="'.$order_by.'" data-product_type="'.$type_home7.'" />
                    ...
                    case 'home-3':
                        $html .=    '<div class="popular-cat-box '.$color2.'">
                        ...
                        $html .=            '<div class="col-md-9 col-sm-8 col-xs-12">
                                                <div class="popular-cat-content">
                                                    <div class="popular-cat-tab-title">
                                                        <ul>
                                                            <li class="active"><a href="'.esc_url('#best1-'.$pre).'" data-toggle="tab">'.esc_html__("best sellers","supershop").'</a></li>
                                                            <li><a href="'.esc_url('#new1-'.$pre).'" data-toggle="tab">'.esc_html__("new products","supershop").'</a></li>
                                                        </ul>
                                                        <a href="'.esc_url($link).'" class="viewall">'.esc_html__("View all","supershop").'</a>
                                                    </div>
                    ...
                    default:
                        $html .=    '<div class="clearfix category-product-featured '.$color.'">                        
                                        <input type="hidden" class="data-load-ajax" data-cat="'.$term->slug.'" data-number="'.$number.'" data-order="'.$order.'" data-orderby="'.$order_by.'" data-product_type="" />
                                    <div class="category-home-total">
                                        <div class="category-home-label">
...
if(empty($check_add)) add_action( 'vc_before_init_base','sv_add_product_category',10,100 );
    if ( ! function_exists( 'sv_add_product_category' ) ) {
        function sv_add_product_category(){
            vc_map( array(
                "name"      => esc_html__("SV Product List Category", 'supershop'),
                ...
                "params"    => array(
                    array(
                        ...
                        'value'       => array(
                            ...
                            esc_html__( 'Home 2 (Advantage)', 'supershop' ) => 'home-2-adv',
                            esc_html__( 'Home 2 (Category left)', 'supershop' ) => 'home-2-left',
                            esc_html__( 'Home 3', 'supershop' ) => 'home-3',
                            esc_html__( 'Home 7', 'supershop' ) => 'home-7',
                            esc_html__( 'Home 8', 'supershop' ) => 'home-8',
                            esc_html__( 'Home 9', 'supershop' ) => 'home-9',
                            esc_html__( 'Home 9 (adv)', 'supershop' ) => 'home-9-2',
                            esc_html__( 'Home 10', 'supershop' ) => 'home-10',
                            esc_html__( 'Home 11', 'supershop' ) => 'home-11',
                            esc_html__( 'Home 12', 'supershop' ) => 'home-12',
                            esc_html__( 'Home 19', 'supershop' ) => 'home-19',
                            ),
                    ),
                    array(
                        "type" => "textfield",
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__( 'Show View More Button', 'supershop' ),
                    ...
                    array(
                        "type" => "textfield",
                        "heading" => esc_html__("Link All",'supershop'),
                        "param_name" => "link",
                        'dependency'  => array(
                            'element'   => 'style',
                            'value'   => 'home-3',
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__( 'Content Position', 'supershop' ),
                        'param_name'  => 'content_pos',
                        'value'       => array(
                            esc_html__( 'Right', 'supershop' )     => 'right',
                            esc_html__( 'Left', 'supershop' )   => 'left',
                            ),
                        'dependency'  => array(
                            'element'   => 'style',
                    ...
                    array(
                        "type" => "textfield",
                        "heading" => esc_html__("Categories Childrent Number",'supershop'),
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__( 'Color', 'supershop' ),
                        'param_name'  => 'color2',
                        'value'       => array(
                            esc_html__( 'Blue', 'supershop' )     => '',
                            esc_html__( 'Yellow', 'supershop' )   => 'yellow-box',
                            ),
                        'edit_field_class'=>'vc_col-sm-6 vc_column',
                        'dependency'  => array(
                            'element'   => 'style',
                    ...
                    array(
                        ...
                        'param_name'  => 'color',
                        'value'       => array(
                            esc_html__( 'Red', 'supershop' ) => 'red-box',
                            esc_html__( 'Yellow', 'supershop' ) => 'yellow-box',
                            esc_html__( 'Pink', 'supershop' ) => 'pink-box',
                            esc_html__( 'Blue', 'supershop' ) => 'blue-box',
                            esc_html__( 'Green', 'supershop' ) => 'green-box',
                            esc_html__( 'Violet', 'supershop' ) => 'violet-box',
                            ),
                        'edit_field_class'=>'vc_col-sm-6 vc_column',
                        'dependency'  => array(
                            'element'   => 'style',
                    ...
                    array(
                        ...
                        'value'       => array(
                            ...
                            esc_html__( 'Yellow', 'supershop' ) => 'yellow-box',
                            esc_html__( 'Pink', 'supershop' ) => 'pink-box',
                            esc_html__( 'Blood', 'supershop' ) => 'blood-box',
                            esc_html__( 'Red Dark', 'supershop' ) => 'darkred-box',
                            esc_html__( 'Blue Sky', 'supershop' ) => 'cyan-box',
                            ),
                        'edit_field_class'=>'vc_col-sm-6 vc_column',
                        'dependency'  => array(
                            'element'   => 'style',
                    ...
                    array(
                        ...
                        'param_name'  => 'color3',
                        'value'       => array(
                            esc_html__( 'Red', 'supershop' ) => 'red-box7',
                            esc_html__( 'Red Dark', 'supershop' ) => 'red-dark-box',
                            esc_html__( 'Blue', 'supershop' ) => 'blue-box7',
                            esc_html__( 'Yellow', 'supershop' ) => 'yellow-box7',
                            esc_html__( 'Pink', 'supershop' ) => 'pink-box',
                            ),
                        'edit_field_class'=>'vc_col-sm-6 vc_column',
                        'dependency'  => array(
                    ...
                    array(
                        "type" => "attach_image",
                        "heading" => esc_html__("Category Icon",'supershop'),
                        "param_name" => "icon",
                        'edit_field_class'=>'vc_col-sm-6 vc_column',
                        'dependency'  => array(
                            'element'   => 'style',
                    ...
                    array(
                        "type" => "attach_image",
                        "heading" => esc_html__("Category Image",'supershop'),
                        "param_name" => "image",
                        'edit_field_class'=>'vc_col-sm-6 vc_column',
                        'dependency'  => array(
                            'element'   => 'style',
                    ...
                    array(
                        "type" => "textfield",
                        "heading" => esc_html__("Image link",'supershop'),
                    ...
                    array(
                        "type" => "attach_image",
                        "heading" => esc_html__("Image Adv 2",'supershop'),
                    ...
                    array(
                        "type" => "textfield",
                        "heading" => esc_html__("Image link 2",'supershop'),
                    ...
                    array(
                        "type" => "checkbox",
                        "heading" => esc_html__("Product type fillter",'supershop'),
                        "param_name" => "types_fillter",
                        "value" => array(
                            esc_html__("Bestsell",'supershop')        => 'bestsell',
                            esc_html__("Most View",'supershop')       => 'mostview',
                            esc_html__("Featured",'supershop')        => 'featured',
                            esc_html__("New Arrivals",'supershop')    => 'newarrival',
                            esc_html__("Most Review",'supershop')     => 'mostreview',
                    ...
                    array(
                        'type'        => 'checkbox',
                        'holder'      => 'div',
                        'heading'     => esc_html__( 'Product Tags', 'supershop' ),
                        'param_name'  => 'tags',
                    ...
                    array(
                        "type" => "add_brand",
                        "heading" => esc_html__("Product Brand",'supershop'),
                        "param_name" => "brands",
                        "group" => esc_html__("Brands",'supershop'),
                    ),
                    array(
                        "type" => "add_advantage",
                        "heading" => esc_html__("Product Adv",'supershop'),
                        "param_name" => "advs",
                        "group" => esc_html__("Adv Content",'supershop'),
                        'dependency'  => array(
                            'element'   => 'style',
                    ...
                    array(
                        "type" => "textarea_html",
                        "heading" => esc_html__("Content Adv",'supershop'),
                        "param_name" => "content",
                        'dependency'  => array(
                            'element'   => 'style',
                            'value'   => array('home-10'),
