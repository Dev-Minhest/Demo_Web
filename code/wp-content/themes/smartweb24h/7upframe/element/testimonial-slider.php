...
if(!function_exists('sv_vc_testimonial_slider'))
{
    function sv_vc_testimonial_slider($attr, $content = false)
    {
        ...
        if(!empty($link)) $html .=  '<a href="'.esc_url($link).'" class="viewall">'.esc_html__("View All","supershop").'</a>';
        $html .=    '</div>';
...
vc_map( array(
    "name"      => esc_html__("SV Testimonial Slider", 'supershop'),
    ...
    "params"    => array(
        ...
        array(
            "type" => "dropdown",
            "heading" => esc_html__("Navigation",'supershop'),
            "param_name" => "nav",
            "value"     => array(
                esc_html__("Circle",'supershop')      => '',
                esc_html__("Square",'supershop')      => 'rect-arrow',
                )
        )
    )
));
...
vc_map( array(
    "name"      => esc_html__("SV Testimonial Item", 'supershop'),
