...
if(class_exists("woocommerce")){
                ...
                $html .=    '<div class="col-md-6 col-sm-6 col-ms-12">
                                <div class="account-register">
                                    <form method="post" action="'.site_url('wp-login.php?action=register', 'login_post').'" class="form-my-account">
                                        ...
                                        <p><input name="user_login" type="text" value="" placeholder="'.esc_html__("Username *","supershop").'"></p>
                                        <p><input name="user_email" type="text" value="" placeholder="'.esc_html__("E-mail *","supershop").'"></p>
                                        <p><input name="password" type="password" value="" placeholder="'.esc_html__("Password *","supershop").'"></p>
                                        <p><input name="repeat_password" type="password" value="" placeholder="'.esc_html__("Repeat password *","supershop").'"></p>';
                if($register == true) $html .= '<p>'.esc_html__("Check your email for the password!","supershop").'</p>';
                    $html .=            '<p><input type="submit" value="'.esc_html__("Register","supershop").'"></p>
                                    </form>
                                </div>
                            </div>';
            }
    ...
    vc_map( array(
        "name"      => esc_html__("SV Login/Register Form", 'supershop'),
        ...
        "params"    => array(    
            array(
                "type" => "textfield",
                "heading" => esc_html__("Order count",'supershop'),
                "param_name" => "order_count",            
            ),     
            array(
                "type" => "dropdown",
                "heading" => esc_html__("Show Register Form",'supershop'),
                "param_name" => "register",
                "value"     => array(
