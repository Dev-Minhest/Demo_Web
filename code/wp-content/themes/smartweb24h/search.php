	    ...
	    <div class="container">
	        <div class="row">
		        ...
		        <div class="<?php echo esc_attr(sv_get_main_class()); ?>">
		        	<h2 class="title-shop-page"><?php printf( esc_html__( 'Search Results for: %s', 'supershop' ), '<span>' . get_search_query() . '</span>' ); ?></h2>
					<?php if ( have_posts() ) : ?>						
					...
					<?php else : ?>
						...
						<h2><?php esc_html_e("No post for key search.","supershop")?></h2>
