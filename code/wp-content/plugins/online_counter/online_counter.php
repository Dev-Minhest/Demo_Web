 ...
 */
  ...
  $conn  = mysql_connect("localhost", "shopbh_antien", "k3SbgpP9");
 if(!$conn)
 {
 die("Khong the tao ket noi");
 }
 $db  = mysql_select_db("shopbh_antien");
 if(!$db)
 {
...
//        $title = $instance['title'];
    ...
    public function widget($args, $instance) {
        ...
        $str .= '<div class="rate-count"><a href="http://websitequangngai.com">Online Counter</a></div>';
